...
window.DIPUTADA_CONFIG = {
    ...
    fecha: '2026-06-17',
    resumen: 'Cuando una comunidad se une por una causa, los resultados pueden cambiar vidas. Gracias a la recolección de PET y tapitas impulsada por la diputada Ana Balderas, el joven Jerson podrá escuchar por primera vez este jueves 18 de junio. La campaña sigue activa para apoyar a Lupita en su lucha contra el cáncer.',
    cuerpo: [
        'Atizapán de Zaragoza, Estado de México. — Cientos de familias atizapenses se sumaron a la recolección de PET y tapitas para hacer realidad el sueño de Jerson, quien nunca había tenido la oportunidad de escuchar.',
